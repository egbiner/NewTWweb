...
public class Upload : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //文件保存目录URL
        String saveUrl = aspxUrl + "../../Web/upload/";
        ...
        if (Referer.IndexOf("scroll_img.aspx") > -1)
        {
            ...
            SqlHelper.ExecuteNonQuery("insert into scroll_img(image_url) values(@image_url)",
                new System.Data.SqlClient.SqlParameter("@image_url", "Web/upload/image/"+fileName));
        }
        ...
        */
        ...
        fileName = DateTime.Now.ToString("yyyyMMddHHmmss_ffff", DateTimeFormatInfo.InvariantInfo) + fileName;
